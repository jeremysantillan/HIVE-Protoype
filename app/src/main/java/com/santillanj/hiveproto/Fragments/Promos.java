...
import com.santillanj.hiveproto.Adapters.PromosAdapter;
...
public class Promos extends Fragment{
    ...
    private String TAG = "PromosFragment";
    private String KEY_LAYOUT_MANAGER ="layoutManager";
    private static final int GRID_COLUMNS = 2;

    protected RecyclerView.LayoutManager mLayoutManager;
    protected Promos.LayoutManagerType mCurrentLayoutManagerType;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mCurrentLayoutManagerType = Promos.LayoutManagerType.GRID_LAYOUT_MANAGER;

        if (savedInstanceState != null) {
            mCurrentLayoutManagerType = (Promos.LayoutManagerType) savedInstanceState.getSerializable(KEY_LAYOUT_MANAGER);
        }
        setRecyclerViewLayoutManager(mCurrentLayoutManagerType);

        ArrayList<CateringServices> cateringlist = addData();
        mAdapter = new PromosAdapter(cateringlist);
    ...
    public void setRecyclerViewLayoutManager(Promos.LayoutManagerType layoutManagerType) {
